...
namespace PST4
{
	...
	public:
		...
		//The size of the playback buffer is dynamically chosen
		...
		constexpr static size_t BUFFER_SIZE{ FRAMES_PER_BUFFER * FRAME_SIZE };	//Size of one buffer, in sample count. For speex compression, must be
